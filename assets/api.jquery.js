...
void 0 === window.Shopify && (window.Shopify = {}),
  ...
  (Shopify.formatMoney = function (t, r) {
    ...
    function e(t, r, e, a) {
      if (
        ((r = o(r, 2)), (e = o(e, ",")), (a = o(a, ".")), isNaN(t) || null == t)
      )
        return 0;
      var n = (t = (t / 100).toFixed(r)).split(".");
      return (
        n[0].replace(/(\d)(?=(\d\d\d)+(?!\d))/g, "$1" + e) +
        (n[1] ? a + n[1] : "")
      );
    }
  ...
  (Shopify.getCart = function (t) {
    jQuery.getJSON(window.router + "/cart.js", function (r) {
  ...
  (Shopify.pollForCartShippingRatesForDestination = function (t, r, o) {
    o = o || Shopify.onError;
    var e = function () {
      jQuery.ajax(window.router + "/cart/async_shipping_rates", {
        dataType: "json",
        success: function (o, a, n) {
          200 === n.status
            ? "function" == typeof r
              ? r(o.shipping_rates, t)
  ...
  (Shopify.getCartShippingRatesForDestination = function (t, r, o) {
    ...
    var e = {
      type: "POST",
      url: window.router + "/cart/prepare_shipping_rates",
  ...
  (Shopify.clear = function (t) {
    var r = {
      type: "POST",
      url: window.router + "/cart/clear.js",
      data: "",
      dataType: "json",
      success: function (r) {
        "function" == typeof t ? t(r) : Shopify.onCartUpdate(r);
  ...
  (Shopify.updateCartFromForm = function (t, r) {
    var o = {
      type: "POST",
      url: window.router + "/cart/update.js",
      data: jQuery("#" + t).serialize(),
      dataType: "json",
      success: function (t) {
        "function" == typeof r ? r(t) : Shopify.onCartUpdate(t);
          ...
          ? jQuery.each(r, function (r, e) {
              rbracket.test(t)
                ...
                : Shopify.buildParams(
                    t +
                      "[" +
                      ("object" == typeof e || jQuery.isArray(e) ? r : "") +
                      "]",
                    e,
                    o
                  );
